...
async function main(withIP = true) {
    ...
    const meteo = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${ville}&appid=8e602b9ea28ed4f9f8fc97a5f6d1105c&lang=fr&units=metric`).then(result => result.json()).then(json => json)
    //console.log(meteo);
